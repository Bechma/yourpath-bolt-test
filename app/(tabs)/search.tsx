						...
						<View style={styles.section}>
							...
							<View style={styles.recentSearches}>
								{recentSearches.map((search) => (
									<Pressable key={search} style={styles.recentSearchItem}>
						...
						<View style={styles.section}>
							...
							<View style={styles.instructors}>
								{popularInstructors.map((instructor) => (
									<Pressable key={instructor.name} style={styles.instructorCard}>
										<View style={styles.instructorAvatar}>
											<Text style={styles.instructorInitial}>{instructor.name.charAt(0)}</Text>
										</View>
										<View style={styles.instructorInfo}>
											...
											<View style={styles.instructorStats}>
												...
												<Text style={styles.instructorStudents}>{instructor.students} students</Text>
											</View>
										</View>
									</Pressable>
								))}
				...
				{searchQuery !== "" && (
					<View style={styles.section}>
						...
						<View style={styles.noResults}>
							...
							<Text style={styles.noResultsText}>Start typing to search for courses, instructors, and topics</Text>
						</View>
					</View>
				)}
			</ScrollView>
